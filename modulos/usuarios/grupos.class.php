	            ...
	            ?>
	              <tr>
	                ...
	                <td class="col-xl-offset-2 accione">
	                  <a  id="btn-editar-modulo" class="btn btn-accion btn-editar <?php echo $aux; ?>" href="grupos.adm.php?tarea=form_editar&id=<? echo $fila_id; ?>" title="Editar <? echo $fila_id; ?>" ><i class="icn-pencil"></i></a>
