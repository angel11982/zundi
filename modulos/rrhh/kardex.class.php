          ...
          <?php
           ...
           /* else{
            ...
            <tr>
              ...
              <td><?php	echo $fila_exp; ?> </td>
              <td>
              	 <a  id="btn-restaurar-modulo" class="btn btn-accion btn-restaurar" href="<? echo $url; ?>" title="Editar <? echo $fila_id; ?>" ><i class="icn-sync"></i></a>
                <a  title="Eliminar <? echo $fila_nombre; ?>" type="button" idEliminar="<? echo $fila_id; ?>" nombreEliminar="<? echo $fila_nombre; ?>" tarea="vaciar_id" class="btn btn-eliminar btn-accion"><i class="icn-trash"></i></a>
              </td>
            </tr>
            <?php
             } // Fin for query1
